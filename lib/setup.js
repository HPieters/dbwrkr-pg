...
function createQueueTable(pool, options, done) {
    ...
    const query = `
        ...
        CREATE INDEX "wrkr_queues_name_index" on "public"."wrkr_queues" ("name");
        `;
...
function createSubscriptionsTable(pool, options, done) {
    ...
    const query = `
        ...
        ALTER TABLE "public"."wrkr_subscriptions" ADD FOREIGN KEY ("event_id") REFERENCES "public"."wrkr_events"("id");
        ALTER TABLE "public"."wrkr_subscriptions" ADD FOREIGN KEY ("queue_id") REFERENCES "public"."wrkr_queues"("id");
        `;
